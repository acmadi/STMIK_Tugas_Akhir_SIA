...
<head>
    ...
    <link href="<?php echo base_url(); ?>asset/dist/css/bajo.css" rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                <?php if(isset($error)){ ?>
                <div class="alert alert-danger alert-dismissable jarak-atas-50">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    Maaf Username atau Password salah.  Jika belum terdaftar silahkan daftar lewat link berikut <a href="<?php echo base_url() ?>auth/register" class="alert-link">Daftar</a>.
                </div>
                <?php } ?>

                <?php if(isset($loggedout)){ ?>
                <div class="alert alert-success alert-dismissable jarak-atas-50">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    Berhail logout.
                </div>
                <?php } ?>
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="<?php echo base_url() ?>auth/post_login">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="passwros" name="password" type="password" value="">
                                </div>
